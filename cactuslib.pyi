...
from base_plugin import BasePlugin, HookResult as HookResult, HookStrategy as HookStrategy, MenuItemData as MenuItemData, MenuItemType as MenuItemType
from contextlib import contextmanager
from dataclasses import dataclass
from enum import Enum
from org.telegram.messenger import MessageObject  # type: ignore
from org.telegram.tgnet import TLObject, TLRPC  # type: ignore
...
class CactusUtils:
    ...
    class Telegram:
        ...
        class TLRPCException(Exception):
            ...
            text: str
            req_id: int
            def __init__(self, req_id: int, error: TLRPC.TL_error) -> None: ...
        @staticmethod
        def tlrpc_object(request_class, **kwargs): ...
        @classmethod
        def send(cls, req, callback: callable | None = None, *, wait_response: bool = True, timeout: int = 7, raise_errors: bool = True) -> int | Result: ...
        send_request = send
        ...
        @classmethod
        def search_messages(cls, dialog_id: int, query: str | None = None, from_id: int | None = None, offset_id: int = 0, limit: int = 20, reply_message_id: int | None = None, top_message_id: int | None = None, filter: SearchFilter = ..., **kwargs) -> list[MessageObject]: ...
        @staticmethod
    ...
    @classmethod
    def get_message_by_rnd_in_current_chat(cls, rnd: str): ...
    @contextmanager
